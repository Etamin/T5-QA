...
dh_summary = pd.read_csv("data/scene_summary.csv",sep='\t',header=0)
dh_qa=pd.read_csv("data/knowit_data_train.csv",sep='\t',header=0)
dh_vd=pd.read_csv("data/scenes_descriptions.csv",sep='\t',header=0)
data=[]
for ind, row in dh_qa.iterrows():
    #print(row)
...
T5Trainer(dataframe=dh, source_text="text", target_text="correct", model_params=model_params, output_dir="outputs")
